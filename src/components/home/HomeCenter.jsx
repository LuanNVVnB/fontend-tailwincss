    ...
    return (
        <> <div>
            <div className="container px-8 md:px-12 xl:max-w-5xl mx-auto lg:px-7 xl:px-0">
                <div className="md:flex md:gap-12 pt-2 lg:pt-56 ">
                        ...
                        <div className="md:-mr-32">
                            <form action="" className="w-full mt-12">
                                <div className="relative flex items-center p-1 rounded-full bg-white border border-sky-200 shadow-md md:p-2">
                                    ...
                                    <input placeholder="Your mail address" className="w-full p-4 rounded-full placeholder-gray-600 focus:outline-none border-none" type="email" />
                    ...
                    <div className="mt-2 h-56 mr-0 md:-mr-24 hidden sm:h-72 md:h-auto md:mt-0 lg:mr-0 lg:-mt-12 md:w-7/12 lg:flex">
                        <img src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8bWVufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="" />
                    </div>
                </div>
            </div>
        </div ></>
